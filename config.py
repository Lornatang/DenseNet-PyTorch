...
if mode == "train":
    ...
    pretrained_model_weights_path = "./results/pretrained_models/DenseNet121-ImageNet_1K-30a6e303.pth.tar"
...
if mode == "test":
    ...
    model_weights_path = "./results/pretrained_models/DenseNet121-ImageNet_1K-30a6e303.pth.tar"
